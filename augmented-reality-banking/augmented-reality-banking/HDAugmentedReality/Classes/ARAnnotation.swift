...
open class ARAnnotation: NSObject {
    ...
    @objc internal(set) open var distanceFromUser: Double = 0
    @objc internal(set) open var azimuth: Double = 0
    @objc internal(set) open var verticalLevel: Int = 0
    @objc internal(set) open var active: Bool = false
