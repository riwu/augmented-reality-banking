        ...
        if backVideoDevice != nil {
            ...
            if error == nil {
                ...
                if captureSession!.canAddInput(videoInput) {
                    ...
                    error = NSError(domain: "HDAugmentedReality", code: 10_002, userInfo: ["description": "Error adding video input."])
                }
            } else {
                error = NSError(domain: "HDAugmentedReality", code: 10_001, userInfo: ["description": "Error creating capture device input."])
            }
        } else {
            error = NSError(domain: "HDAugmentedReality", code: 10_000, userInfo: ["description": "Back video device not found."])
        }
